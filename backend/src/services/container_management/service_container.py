...
class ContainerService:
    ...
    def get_container_logs(self, container_id_or_name: str, tail: int = 100, stdout: bool = True, stderr: bool = True, timestamps: bool = True) -> list[str]:
        """
        ...
        try:
            logs = container.logs(stdout=stdout, stderr=stderr, tail=tail, timestamps=timestamps)
